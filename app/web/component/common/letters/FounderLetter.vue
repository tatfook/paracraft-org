<template>
  <div class="founder-letter">
    <div class="founder-letter-title">How to learn programming</div>
    <div class="founder-letter-content">
      ...
      <p>Core takeaway:<br>
        Playing lots of good games is very important to let the kids know what they want to build themselves when they grow up. Kids who only play a few games will not have any ideas of what projects they want to build. Instead, kids needs to play as many games as possible and be really good at them.</p>
      <p>Key Point-3<br>
      ...
      <p>Core takeaway:<br>
        Introduce kids to playing on PC as early as possible. Teach them typing with a keyboard and a mouse. Choose the right operating system (prefer Windows, MAC is fine today, but not back then)!</p>
      <p>Key Point-4<br>
