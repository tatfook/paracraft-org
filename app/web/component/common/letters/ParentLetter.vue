<template>
  <div class="parent-letter">
    ...
    <div class="parent-letter-content">
      <div class="parent-letter-content-title">Schools should be more like kindergartens, not the other way around</div>
      ...
      <p>Here at Paracraft, we agree 100% with the ideas and beliefs outlined in the above two essays. Actually Paracraft itself is a strong testimony to those ideas and beliefs.</p>
      ...
      <div class="parent-letter-content-title">ParaWorld, where everyone can create their own games</div>
      ...
      <div class="parent-letter-content-title-sub">Digital skills</div>
      ...
      <p>If you need to add complex logic to your characters, you can write code. Software programming, in our view, is another essential skill that people of our modern world need to grasp.</p>
