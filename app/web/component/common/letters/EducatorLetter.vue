<template>
  <div class="educator-letter">
    ...
    <div class="educator-letter-content">
      ...
      <p>In paracraft, we aim to create a parallel world where everyone can create their own games or creative 3D works. We call such a world with the coined name “ParaWorld”. Paracraft is a very expressive and powerful tool that people can use to create all kinds of complex 3D works. Our users’ works have demonstrated this very clearly. No matter what your family background is, in paracraft, you can immerse yourself in all kinds of creative works. We believe this is where education starts.</p>
      <p>As a former biology student, when I was studying biology in school, the textbook used large paragraph of text to just describe what the cell or tissue looks like. You spent time reading it and tried to imagine what it is really like. It is very time consuming. Most of the time is wasted on such things. In American graduate schools, we have large text books with beautiful colorful pictures. That is much better. You see quite immediately what it looks like and it saves tons of time. What can be even better, is that we can create, for example, 3D model of the cell, and you can enter the membrane of the cell, and swim around inside the cell, enter cell organelles and interact with them. We believe paracraft can play a great role in teaching of biology by having teachers and students creating 3D worlds, movies, and games.</p>
